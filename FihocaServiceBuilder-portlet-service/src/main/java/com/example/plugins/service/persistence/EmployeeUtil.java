...
public class EmployeeUtil {
    ...
    */
    public static void cacheResult(com.example.plugins.model.Employee employee) {
    ...
    */
    public static com.example.plugins.model.Employee create(int eid) {
    ...
    */
    public static com.example.plugins.model.Employee remove(int eid)
        throws com.example.plugins.NoSuchEmployeeException,
            com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().remove(eid);
    }

    public static com.example.plugins.model.Employee updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.example.plugins.model.Employee findByPrimaryKey(int eid)
        throws com.example.plugins.NoSuchEmployeeException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.example.plugins.model.Employee fetchByPrimaryKey(int eid)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.example.plugins.model.Employee> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static EmployeePersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (EmployeePersistence) PortletBeanLocatorUtil.locate(com.example.plugins.service.ClpSerializer.getServletContextName(),
